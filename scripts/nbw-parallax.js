...
$(document).ready(function() { //when the document is ready...
	...
	var bg4 = $("#second .bg4");
	var $balao= $("#intro .bg");
	var $indesign= $("#intro .bg1");
	var $photoshop= $("#intro .bg2");
	var $ilustrator= $("#intro .bg3");
	...
	*/
	...
	function Move(){ 
		...
		if($secondBG.hasClass("inview")){
			//call the newPos function and change the background position
			$secondBG.css({'backgroundPosition': newPos(5, windowHeight, pos, 1400, 0.5)});
			//call the newPos function and change the secnond background position
			bg.css({'backgroundPosition': newPos(25, windowHeight, pos, 3350, 0.3)});
			bg2.css({'backgroundPosition': newPos(50, windowHeight, pos, 4350, 0.2)});
			bg3.css({'backgroundPosition': newPos(35, windowHeight, pos, 3300, 0.4)});
			bg4.css({'backgroundPosition': newPos(55, windowHeight, pos, 5850, 0.1)});
		}
		...
		//if the fifth section in view...
		if($fifthBG.hasClass("inview")){
			//call the newPos function and change the background position for CSS3 multiple backgrounds
			$fifthBG.css({'backgroundPosition': newPos(0, windowHeight, pos, 0, 0.9) + ", " + newPos(50, windowHeight, pos, -200, 0.7) + ", " + newPos(50, windowHeight, pos, -200, 0.5) + ", " + newPos(50, windowHeight, pos, 500, 0.3)});
		}
